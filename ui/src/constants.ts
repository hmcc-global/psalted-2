...
export const flatMusicKeysOptions = ['C', 'Db', 'D', 'Eb', 'E', 'F', 'Gb', 'G', 'Ab', 'A', 'Bb', 'B', 'C'];
export const sharpMusicKeysOptions = ['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B', 'C'];
...
//chord colors:
export const ChordColors:   Record<string, string> = {"C": '#FAFABE',
                                                      "C#": '#DAFABE',
                                                      "Db": '#DAFABE',
                                                      "D": '#C1EBC0',
                                                      "D#": '#C0EBE9',
